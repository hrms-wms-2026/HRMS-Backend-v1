...
- `next/2026-08-13-verified-employee-check-in-design.md` is pending; its live AWS/hardware gate and implementation Parts 2-4 remain.
- `next/2026-08-13-tray-monitoring-completion-roadmap-design.md` is the approved master sequence. Detailed plans are created and executed one milestone at a time, beginning with live AWS biometric enrollment E2E.
