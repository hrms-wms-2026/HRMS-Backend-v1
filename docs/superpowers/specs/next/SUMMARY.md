...
- `2026-08-16-multi-legal-entity-employment-foundation-design.md` — status: pending, **plan written** (`plans/next/2026-08-16-multi-legal-entity-employment-foundation/` — 3 parts, not yet implemented). Sub-project 1 of 2 (foundation: multi-legal-entity employment, invitation lifecycle, position capacity reservation, session active-entity/permission recompute). Sub-project 2 (Employee Detail screen, sensitive-field gating, Change Position action) will be a separate design written after this one is planned.
