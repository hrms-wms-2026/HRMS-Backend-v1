...
- `2026-08-15-employee-self-service-profile-backend-design.md` — status: **finished but not yet moved**. Its plan (`plans/next/2026-08-15-employee-self-service-profile-backend.md`) is fully executed and merged (branch `feature/employee-profile-backend`, same commit as base branch `feature/employee-management-phase1-foundation` as of 2026-08-16) — should move to `specs/finished/2026-08-16/` alongside its plan, not done here since it was out of this session's scope.
