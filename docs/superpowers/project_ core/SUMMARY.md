...
- `phase1-table-inventory.md` — full column-level definitions for all **249 Phase 1 tables** (242 core + 7 Developer Platform Extensions). See breakdown below. Structural verification against actual EF configurations/migrations is queued as Phase 3.
