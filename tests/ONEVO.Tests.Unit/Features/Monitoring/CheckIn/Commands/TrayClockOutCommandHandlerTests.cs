...
public class TrayClockOutCommandHandlerTests
{
        ...
        ClockOutCommandHandler inner)
    {
        ...
        return new TrayClockOutCommandHandler(device.Object, todayState.Object, inner, tenants.Object, switcher.Object);
    }
    ...
    public async Task Handle_NotAuthenticated_ReturnsFailure()
    {
        ...
        var (tenants, switcher) = CreateTenantMocks();
        var sut = new TrayClockOutCommandHandler(device.Object, todayState.Object, inner: null!, tenants.Object, switcher.Object);
