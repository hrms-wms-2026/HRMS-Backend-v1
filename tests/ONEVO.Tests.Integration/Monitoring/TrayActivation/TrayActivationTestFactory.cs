...
public sealed class TrayActivationTestFactory : WebApplicationFactory<Program>
{
    private readonly string _connectionString;

    public TrayActivationTestFactory(string connectionString) => _connectionString = connectionString;
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((ctx, config) =>
        {
            config.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["Jwt:Secret"] = "tray-test-jwt-secret-min-32-chars-long!!",
                ["Jwt:TenantIssuer"] = "onevo-api",
                ["Jwt:TenantAudience"] = "onevo-api",
                ["TrayApp:Jwt:Secret"] = "tray-test-tray-jwt-secret-min-32chars!!",
                ["Tenancy:RootDomain"] = "localhost",
                ["Urls:AppBaseUrl"] = "https://localhost",
                ["Encryption:MasterKey"] = "tray-activation-test-master-key-32-chars!",
                ...
                ["PlatformBootstrap:SuperAdminFullName"] = "Tray Activation Test Super Admin"
            });
        });
