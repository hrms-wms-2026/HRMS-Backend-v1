...
public sealed class TrayMonitoringPolicyTestFactory : WebApplicationFactory<Program>
{
    private readonly string _connectionString;

    public TrayMonitoringPolicyTestFactory(string connectionString) => _connectionString = connectionString;
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((ctx, config) =>
        {
            config.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["Jwt:Secret"] = "policy-test-jwt-secret-min-32-chars-long!!!",
                ["Jwt:TenantIssuer"] = "onevo-api",
                ["Jwt:TenantAudience"] = "onevo-api",
                ["TrayApp:Jwt:Secret"] = "policy-test-tray-jwt-secret-min-32chars!!",
                ...
                ["Encryption:MasterKey"] = "policy-test-master-key-32-chars-xxxxxx!",
                ...
                ["PlatformBootstrap:SuperAdminFullName"] = "Policy Test Super Admin"
            });
        });
