...
namespace ONEVO.Infrastructure.Migrations
{
    ...
    [Migration("20260825060631_AddFeatureFlags")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ONEVO.Domain.Features.SharedPlatform.Entities.FeatureFlag", b =>
                {
                    ...
                    b.HasIndex("FeatureKey")
                        .HasDatabaseName("ix_feature_flags_feature_key");

                    b.HasIndex("ModuleKey")
                        .HasDatabaseName("ix_feature_flags_module_key");

                    b.ToTable("feature_flags", (string)null);
                });

            modelBuilder.Entity("ONEVO.Domain.Features.SharedPlatform.Entities.FeatureFlagOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("GrantedById")
                        .HasDatabaseName("ix_feature_flag_overrides_granted_by_id");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_feature_flag_overrides_tenant_id");

                    b.HasIndex("FlagKey", "TenantId")
                        .IsUnique()
                        .HasDatabaseName("ix_feature_flag_overrides_flag_key_tenant_id");
            ...
            modelBuilder.Entity("ONEVO.Domain.Features.SharedPlatform.Entities.FeatureFlag", b =>
                {
                    b.HasOne("ONEVO.Domain.Features.SharedPlatform.Entities.ModuleFeature", "Feature")
                        .WithMany()
                        .HasForeignKey("FeatureKey")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_feature_flags_module_features_feature_key");

                    b.HasOne("ONEVO.Domain.Features.SharedPlatform.Entities.ModuleCatalogItem", "Module")
                        .WithMany()
                        .HasForeignKey("ModuleKey")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_feature_flags_module_catalog_module_key");
            ...
            modelBuilder.Entity("ONEVO.Domain.Features.SharedPlatform.Entities.FeatureFlagOverride", b =>
                {
                    b.HasOne("ONEVO.Domain.Features.SharedPlatform.Entities.FeatureFlag", "Flag")
                        .WithMany("Overrides")
                        .HasForeignKey("FlagKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_feature_flag_overrides_feature_flags_flag_key");
                    ...
                    b.HasOne("ONEVO.Domain.Features.DevPlatform.PlatformAccess.Entities.PlatformUser", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_feature_flag_overrides_platform_users_granted_by_id");
                    ...
                    b.HasOne("ONEVO.Domain.Features.InfrastructureModule.Entities.Tenant", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_feature_flag_overrides_tenants_tenant_id");
