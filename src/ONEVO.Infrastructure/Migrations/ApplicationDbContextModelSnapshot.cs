...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ONEVO.Domain.Features.Monitoring.Biometrics.Entities.BiometricVerificationAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset?>("AwsSessionExpiresAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("aws_session_expires_at");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_biometric_verification_attempts");

                    b.HasIndex("TenantId", "AwsSessionId")
                        .IsUnique()
                        .HasDatabaseName("ix_biometric_verification_attempts_tenant_id_aws_session_id");

                    b.HasIndex("TenantId", "EmployeeId", "Purpose", "CreatedAt")
                        .HasDatabaseName("ix_biometric_verification_attempts_tenant_id_employee_id_purpo");

                    b.ToTable("biometric_verification_attempts", (string)null);
                });

            modelBuilder.Entity("ONEVO.Domain.Features.Monitoring.Biometrics.Entities.EmployeeBiometricProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("EnrollmentAttemptId")
                        .HasColumnType("uuid")
                        .HasColumnName("enrollment_attempt_id");
                    ...
                    b.Property<string>("ReferenceStorageKey")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("reference_storage_key");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_employee_biometric_profiles");
                    ...
                    b.ToTable("employee_biometric_profiles", (string)null);
                });
            ...
            modelBuilder.Entity("ONEVO.Domain.Features.Monitoring.Screenshots.Entities.InactivityCaptureAttempt", b =>
                {
                    ...
                    b.HasIndex("WorkSessionId")
                        .HasDatabaseName("ix_inactivity_capture_attempts_work_session_id");
            ...
            modelBuilder.Entity("ONEVO.Domain.Features.WorkManagement.ProjectInvitations.Entities.ProjectMemberInvitation", b =>
                {
                    ...
                    b.HasIndex("TenantId", "InvitedUserId", "Status")
                        .HasDatabaseName("ix_project_member_invitations_tenant_invited_user_status");

                    b.HasIndex("TenantId", "ProjectId", "ObjectiveId", "InvitedUserId")
                        .IsUnique()
            ...
            modelBuilder.Entity("ONEVO.Domain.Features.WorkManagement.ProjectMembers.Entities.ProjectMember", b =>
                {
                    ...
                    b.HasIndex("TenantId", "ProjectId", "ObjectiveId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_project_members_tenant_project_objective_user");

                    b.HasIndex("TenantId", "UserId", "IsActive", "ProjectId")
            ...
            modelBuilder.Entity("ONEVO.Domain.Features.Monitoring.Screenshots.Entities.InactivityCaptureAttempt", b =>
                {
                    ...
                    b.HasOne("ONEVO.Domain.Features.Monitoring.WorkSessions.Entities.EmployeeWorkSession", null)
                        .WithMany()
                        .HasForeignKey("WorkSessionId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_inactivity_capture_attempts_employee_work_sessions_work_ses");
                });
