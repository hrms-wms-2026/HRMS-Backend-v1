...
namespace ONEVO.Infrastructure.Migrations
{
    ...
    [Migration("20260907053622_AddLegalEntityOfficeLocation")]
    partial class AddLegalEntityOfficeLocation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ONEVO.Domain.Features.OrgStructure.Entities.LegalEntity", b =>
                {
                    ...
                    b.Property<int?>("OfficeRadiusMeters")
                        .HasColumnType("integer")
                        .HasColumnName("office_radius_meters");
                    ...
                    b.ToTable("legal_entities", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_legal_entities_office_location", "(office_latitude IS NULL AND office_longitude IS NULL AND office_radius_meters IS NULL) OR (office_latitude IS NOT NULL AND office_longitude IS NOT NULL AND office_radius_meters IS NOT NULL AND office_latitude BETWEEN -90 AND 90 AND office_longitude BETWEEN -180 AND 180 AND office_radius_meters > 0)");
            ...
            modelBuilder.Entity("ONEVO.Domain.Features.CoreHr.Entities.OnboardingDraft", b =>
                {
                    ...
                    b.HasOne("ONEVO.Domain.Lookups.WorkMode", null)
                        .WithMany()
                        .HasForeignKey("WorkModeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_onboarding_drafts_work_modes_work_mode_id");
                });
