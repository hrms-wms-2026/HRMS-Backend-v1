...
public interface ICalendarOAuthTokenExchangeClient
{
    ...
    /// <summary>provider is "google" | "microsoft" | "zoom" (PlatformOAuthProviderCatalog vocabulary,
    /// not CalendarExternalSources) — matches what StartCalendarConnectionCommand/the callback route
