...
public sealed class UnpublishPlatformAnnouncementCommandHandler
    : IRequestHandler<UnpublishPlatformAnnouncementCommand, Result<PlatformAnnouncementDto>>
{
    private readonly IPlatformAnnouncementRepository _announcements;
    private readonly IUnitOfWork _unitOfWork;
    private readonly IDateTimeProvider _clock;

    public UnpublishPlatformAnnouncementCommandHandler(
    ...
    public async Task<Result<PlatformAnnouncementDto>> Handle(
        UnpublishPlatformAnnouncementCommand request,
        CancellationToken ct)
    {
        ...
        // PublishedAt is intentionally left untouched: it records when the
        // announcement was first published, not whether it's currently live.
