...
/// <summary>Mirrors GetProjectByIdQueryHandler's access rule exactly (active project membership) so a project's logo is never more visible than the project itself.</summary>
